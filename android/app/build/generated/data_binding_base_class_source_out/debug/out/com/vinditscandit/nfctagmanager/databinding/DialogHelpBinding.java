...
public final class DialogHelpBinding implements ViewBinding {
  ...
  private DialogHelpBinding(@NonNull LinearLayout rootView,
      @NonNull MaterialButton closeHelpButton) {
  ...
  public static DialogHelpBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.closeHelpButton;
      MaterialButton closeHelpButton = ViewBindings.findChildViewById(rootView, id);
      if (closeHelpButton == null) {
        break missingId;
      }

      return new DialogHelpBinding((LinearLayout) rootView, closeHelpButton);
    }
